...
router.post('/upload', async (req, res) => {
    const { title, description, price, instructorId, classes, thumbnail } = req.body;
    try {
        const newCourse = new Course({ title, description, price, instructorId, status: 'pending', classes, thumbnail });
...
router.put('/update/:courseId', async (req, res) => {
    try {
        ...
        const { title, description, price, classes, thumbnail } = req.body;
